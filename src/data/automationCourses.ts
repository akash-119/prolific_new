...
export const automationCourses: Course[] = [
  {
    ...
    shortDescription:
      "Master industrial automation with hands-on PLC and SCADA programming. Learn Siemens, Allen Bradley, and other leading platforms.",
...
The curriculum is designed in consultation with industry experts and aligns with current industrial practices. Upon completion, students will be capable of designing, programming, and troubleshooting PLC-based automation systems and SCADA applications.`,
      ...
      prerequisites:
        "Basic knowledge of electrical systems and computer fundamentals recommended",
      certifications: [
    ...
    faqs: [
      {
        ...
        answer:
          "The complete course duration is 3-6 months depending on the batch timing you choose, with 180 hours of comprehensive training.",
      },
      {
        question: "Do I need prior programming knowledge?",
        answer:
          "No prior programming experience is required. We start from basics and gradually progress to advanced topics. Basic electrical knowledge is helpful.",
      },
      {
        question: "Will I get hands-on practice?",
        answer:
          "Yes, our training is 70% practical. You'll work on real Siemens and Allen Bradley PLCs in our fully-equipped labs.",
      },
      {
        question: "Is placement assistance provided?",
        answer:
          "Yes, we provide 100% placement assistance with access to 600+ hiring partners. Our placement cell actively helps students secure jobs.",
      },
      {
        question: "Can I attend weekend batches?",
        answer:
          "Yes, we offer flexible batch timings including weekends for working professionals.",
      },
      {
        question: "What certification will I receive?",
        answer:
          "You'll receive an industry-recognized certificate that is ISO 9001-2008 certified and NSDC approved.",
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "Comprehensive training in industrial robots and automation systems including ABB, KUKA, and Fanuc robots.",
...
Our robotics lab features actual industrial robots allowing students to gain real-world experience in robot programming, simulation, and integration with automated production lines.`,
      ...
      prerequisites:
        "Basic understanding of automation concepts recommended. PLC knowledge is helpful but not mandatory.",
    ...
    faqs: [
      {
        ...
        answer:
          "No, we start from fundamentals. Basic engineering knowledge is sufficient.",
      },
      {
        question: "Which robots will I learn?",
        answer:
          "You'll learn ABB, KUKA, and FANUC robots - the top 3 industrial robot manufacturers globally.",
      },
      {
        question: "Is simulation software included?",
        answer:
          "Yes, you'll get hands-on experience with RobotStudio, KUKA.Sim, and ROBOGUIDE.",
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "Comprehensive 1-year diploma covering PLC, SCADA, DCS, Robotics, and advanced automation technologies.",
...
Graduates of this program are highly sought after by leading automation companies and have achieved 100% placement rate with competitive salary packages.`,
      ...
      prerequisites:
        "Engineering degree or diploma with basic electrical knowledge",
      certifications: [
        "ISO 9001-2008 Certified",
        "NSDC Approved",
        "IAO Certified",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes, the diploma is ISO certified, NSDC approved, and industry-recognized.",
      },
      {
        question: "What is the placement record?",
        answer:
          "We have maintained 100% placement for PGDIA graduates with packages ranging from 6-12 LPA.",
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "Learn Distributed Control Systems used in process industries including DeltaV, Honeywell, and Yokogawa platforms.",
...
This course provides hands-on experience with industry-standard DCS systems and prepares students for roles in process automation and control.`,
    ...
    faqs: [
      {
        question: "What industries use DCS?",
        answer:
          "Oil & gas, petrochemicals, power generation, pharmaceuticals, and chemical processing industries primarily use DCS systems.",
      },
      {
        question: "Is DCS different from PLC?",
        answer:
          "Yes, DCS is designed for large-scale continuous process control while PLCs are typically used for discrete manufacturing. We cover the differences in detail.",
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "Learn microcontroller programming, ARM processors, and embedded system design for IoT and automation applications.",
...
This course covers popular platforms including Arduino, ARM Cortex, and ESP32 for IoT applications. Students work on hands-on projects including sensor interfacing, motor control, and wireless communication.`,
    ...
    curriculum: {
      ...
      modules: [
        ...
        },
        {
          ...
          duration: "20 hours",
          topics: ["UART", "SPI", "I2C", "CAN bus", "USB basics"],
        },
        {
          moduleNumber: 5,
    ...
    faqs: [
      {
        ...
        answer:
          "Basic electronics knowledge is helpful but we cover fundamentals in the course.",
      },
      {
        question: "Which microcontrollers will I learn?",
        answer:
          "You'll work with Arduino, STM32 (ARM Cortex-M), ESP32, and 8051 platforms.",
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "Comprehensive electrical engineering training covering power systems, switchgear, drives, and industrial electrical safety.",
...
This program is ideal for electrical technicians and engineers seeking to enhance their skills in industrial electrical systems.`,
    ...
    faqs: [
      {
        question: "Is this suitable for ITI pass students?",
        answer:
          "Yes, this program is designed for ITI electrical pass-outs and diploma holders.",
      },
      {
        question: "Will I learn VFD programming?",
        answer:
          "Yes, you'll get hands-on experience with Siemens and Allen Bradley VFDs.",
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "Master industrial communication protocols including Profibus, Profinet, Modbus, and Ethernet/IP for automation networks.",
    ...
    curriculum: {
      ...
      modules: [
        {
          moduleNumber: 1,
          title: "Industrial Network Fundamentals",
          duration: "10 hours",
          topics: [
            "OSI model",
            "Network topologies",
            "Industrial vs IT networks",
            "Cable types",
            "Network design",
          ],
        },
    ...
    faqs: [
      {
        question: "Do I need networking background?",
        answer:
          "Basic understanding of networks helps but we cover fundamentals from scratch.",
      },
    ],
