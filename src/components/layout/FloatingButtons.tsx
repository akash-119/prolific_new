  ...
  return (
    <>
      ...
      <motion.a
        ...
        className="fixed bottom-6 left-6 z-50 w-14 h-14 rounded-full bg-[hsl(142,70%,45%)] text-card flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow animate-pulse-ring"
